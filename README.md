...
Research Internship work on Image Classification and Generation predicting future images and weather parameter in a combined concatenated proposed CNN + Transformer ML model for the Kosi Region of Bihar.

Satellite Images:
- Trained Vision Transformer (ViT) Model and InceptionV3 Model on satellite image classification and predicted if a new input image is Flood Map or Non-Flood Map
  Acheived an overall accuracy of 93.27498%
- Trained U-Net, ConvLSTM (CNN-LSTM) and CNN + Transformer models on Satellite image map generation and prediction.
